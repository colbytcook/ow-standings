...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function OverwatchAjax($el) {
	  _classCallCheck(this, OverwatchAjax);
	  ...
	  $.when($.get('https://api.lootbox.eu/pc/us/' + timo + '/profile', function (timoData) {
	    ...
	    var arrayReorder = function arrayReorder(profiles, heroes) {
	      var findGamesPlayed = function findGamesPlayed() {};
	    ...
	    var medalAssign = function medalAssign(row, rankings) {
	    ...
	    var lth = function lth(data) {
	      return data.sort();
	    };
	    var htl = function htl(data) {
