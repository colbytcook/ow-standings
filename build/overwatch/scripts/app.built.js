...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComponentReveal = __webpack_require__(2);
	var componentReveal = new ComponentReveal();
	var moduleRegistry = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function ComponentReveal($el) {
		_classCallCheck(this, ComponentReveal);
	
		var host = window.location.host;
		var hostCheck = function hostCheck(urlTarget, hostToCheck) {
	...
	module.exports = {
	  init: function init() {
	    ...
	    $('[data-module]').each(function (i, v) {
	      ...
	      var module = _this.modules[name]($(v));
	    });
	  },
	  modules: {
	    componentReveal: __webpack_require__(4),
	    overwatchAjax: __webpack_require__(5)
	  }
